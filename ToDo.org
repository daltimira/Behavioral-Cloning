...
2- Get more data that train vehicle move from the side to the center.

3- Re-train with the old and new data together.

4- Test and adjust the write up explaining the new additions.

5- Write notes about (from the Q&A) about how to introduce the grayscale and resizing of the images.
