...
new_model = "./dac_net_v23_regularization02_epoch30_data.h5"
...
def main():
    ...
    history_object = model.fit_generator(train_generator, steps_per_epoch= len(train_samples), validation_data=validation_generator, validation_steps=len(validation_samples), epochs=30, verbose = 2, callbacks=[checkpoint, stopper])
    ...
    #plt.show()
    plt.savefig("meanSquaredErrorLoss_v23_regularization02_epoch30_data.png")
